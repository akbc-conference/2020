...
const updateCards = (papers) => {
    ...
    const all_mounted_cards = d3.select('.cards')
      ...
      .join('div')
      .attr('class', p => 'myCard col-xs-6 col-md-4' + (p.recommended? ' recommended' : ''))
      .html(card_html)
...
const card_image = (openreview, show) => {
    if (show) return ` <center><img class="lazy-load-img cards_img" data-src="https://akbc.ws/2020/assets/suppl/${openreview.forum}-teaser.png" width="80%"/></center>`
    else return ''
}
